...
const takeBreakBtn =
    document.getElementById("takeBreak");


const skipBreakBtn =
    document.getElementById("skipBreak");
...
const confirmRedeemBtn =
    document.getElementById("confirmRedeem");


const cancelRedeemBtn =
    document.getElementById("cancelRedeem");


const redeemMinutesInput =
    document.getElementById("redeemMinutes");
